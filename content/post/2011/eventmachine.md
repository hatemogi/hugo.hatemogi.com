...
이상의 과정으로 개발한 간단한 [HTTP proxy서버 코드를 github](https://github.com/hatemogi/em_http_proxy/blob/master/proxy.rb)에 올려놓았습니다. 간단히 만들었지만, 종종 유용히 사용할 수 있을거라 기대하구요, 또 개발/테스트 작업에 필요한 경우에 조금씩 코드를 손봐서 사용할 수도 있을 것 같습니다.
...
![OSX에서 웹프록시 설정](/img/post/em_http_proxy/proxy_setting.png)
